...
void test_dualwheel_newIgn_12_1_trig0_1()
{
    ...
    ignitionSchedule1.ignitionEndAngle = 360 - 10; //Set 10 degrees advance
    ...
    ignitionSchedule1.ignitionEndAngle = 360 - 0; //Set 0 degrees advance
    triggerSetEndTeeth_DualWheel();
    TEST_ASSERT_EQUAL(12, ignition1EndTooth);

    //Test again with 35 degrees advance
    ignitionSchedule1.ignitionEndAngle = 360 - 35; //Set 35 degrees advance
    triggerSetEndTeeth_DualWheel();
...
void test_dualwheel_newIgn_12_1_trig0_2()
{
    ...
    test_setup_dualwheel_12_1();
    configPage4.sparkMode = IGN_MODE_WASTED;
    ignitionSchedule2.ignitionEndAngle = 180 - 10; //Set 10 degrees advance
    configPage4.triggerAngle = 0; //No trigger offset
