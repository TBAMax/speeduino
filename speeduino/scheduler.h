...
#define IGNITION_REFRESH_THRESHOLD  1024U//230U //Time in uS that the refresh functions will check to ensure there is enough time before changing the end compare
