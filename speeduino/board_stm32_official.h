...
inline void FUEL1_TIMER_ENABLE() { (TIM3)->SR = ~TIM_FLAG_CC1; (TIM3)->DIER |= TIM_DIER_CC1IE; }
inline void FUEL2_TIMER_ENABLE() { (TIM3)->SR = ~TIM_FLAG_CC2; (TIM3)->DIER |= TIM_DIER_CC2IE; }
inline void FUEL3_TIMER_ENABLE() { (TIM3)->SR = ~TIM_FLAG_CC3; (TIM3)->DIER |= TIM_DIER_CC3IE; }
inline void FUEL4_TIMER_ENABLE() { (TIM3)->SR = ~TIM_FLAG_CC4; (TIM3)->DIER |= TIM_DIER_CC4IE; }

inline void FUEL1_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC1IE; }
inline void FUEL2_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC2IE; }
inline void FUEL3_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC3IE; }
inline void FUEL4_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC4IE; }

inline void IGN1_TIMER_ENABLE() { (TIM2)->SR = ~TIM_FLAG_CC1; (TIM2)->DIER |= TIM_DIER_CC1IE; }
inline void IGN2_TIMER_ENABLE() { (TIM2)->SR = ~TIM_FLAG_CC2; (TIM2)->DIER |= TIM_DIER_CC2IE; }
inline void IGN3_TIMER_ENABLE() { (TIM2)->SR = ~TIM_FLAG_CC3; (TIM2)->DIER |= TIM_DIER_CC3IE; }
inline void IGN4_TIMER_ENABLE() { (TIM2)->SR = ~TIM_FLAG_CC4; (TIM2)->DIER |= TIM_DIER_CC4IE; }

inline void IGN1_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC1IE; }
inline void IGN2_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC2IE; }
inline void IGN3_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC3IE; }
inline void IGN4_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC4IE; }


inline void FUEL5_TIMER_ENABLE() { (TIM5)->SR = ~TIM_FLAG_CC1; (TIM5)->DIER |= TIM_DIER_CC1IE; }
inline void FUEL6_TIMER_ENABLE() { (TIM5)->SR = ~TIM_FLAG_CC2; (TIM5)->DIER |= TIM_DIER_CC2IE; }
inline void FUEL7_TIMER_ENABLE() { (TIM5)->SR = ~TIM_FLAG_CC3; (TIM5)->DIER |= TIM_DIER_CC3IE; }
inline void FUEL8_TIMER_ENABLE() { (TIM5)->SR = ~TIM_FLAG_CC4; (TIM5)->DIER |= TIM_DIER_CC4IE; }

inline void FUEL5_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC1IE; }
inline void FUEL6_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC2IE; }
inline void FUEL7_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC3IE; }
inline void FUEL8_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC4IE; }

inline void IGN5_TIMER_ENABLE() { (TIM4)->SR = ~TIM_FLAG_CC1; (TIM4)->DIER |= TIM_DIER_CC1IE; }
inline void IGN6_TIMER_ENABLE() { (TIM4)->SR = ~TIM_FLAG_CC2; (TIM4)->DIER |= TIM_DIER_CC2IE; }
inline void IGN7_TIMER_ENABLE() { (TIM4)->SR = ~TIM_FLAG_CC3; (TIM4)->DIER |= TIM_DIER_CC3IE; }
inline void IGN8_TIMER_ENABLE() { (TIM4)->SR = ~TIM_FLAG_CC4; (TIM4)->DIER |= TIM_DIER_CC4IE; }

inline void IGN5_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC1IE; }
inline void IGN6_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC2IE; }
inline void IGN7_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC3IE; }
inline void IGN8_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC4IE; }
