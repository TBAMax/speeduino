...
void loop()
{
    ...
    if ((currentStatus.hasSync || BIT_CHECK(currentStatus.status3, BIT_STATUS3_HALFSYNC)) && (currentStatus.RPM > 0))
    {
      ...
      injector1EndAngle = fuelSchedule1.calculateEndAngle(currentStatus.injAngle);
      ...
      switch (configPage2.nCylinders)
      {
        ...
        //2 cylinders
        case 2:
          injector2EndAngle = fuelSchedule2.calculateEndAngle(currentStatus.injAngle);
        ...
        case 4:
          ...
          if((configPage2.injLayout == INJ_SEQUENTIAL) && currentStatus.hasSync)
          {
            ...
            injector3EndAngle = fuelSchedule3.calculateEndAngle(currentStatus.injAngle);
            injector4EndAngle = fuelSchedule4.calculateEndAngle(currentStatus.injAngle);
        ...
        case 5:
          ...
          injector4EndAngle = fuelSchedule4.calculateEndAngle(currentStatus.injAngle);
          #if INJ_CHANNELS >= 5
          injector5EndAngle = fuelSchedule5.calculateEndAngle(currentStatus.injAngle);
          #endif
          break;
        //6 cylinders
        case 6:
          ...
          injector3EndAngle = fuelSchedule3.calculateEndAngle(currentStatus.injAngle);
            ...
            if((configPage2.injLayout == INJ_SEQUENTIAL) && currentStatus.hasSync)
            {
              ...
              injector4EndAngle = fuelSchedule4.calculateEndAngle(currentStatus.injAngle);
              injector5EndAngle = fuelSchedule5.calculateEndAngle(currentStatus.injAngle);
              injector6EndAngle = fuelSchedule6.calculateEndAngle(currentStatus.injAngle);
        ...
        case 8:
          ...
          injector4EndAngle = fuelSchedule4.calculateEndAngle(currentStatus.injAngle);
            ...
            if((configPage2.injLayout == INJ_SEQUENTIAL) && currentStatus.hasSync)
            {
              ...
              injector5EndAngle = fuelSchedule5.calculateEndAngle(currentStatus.injAngle);
              injector6EndAngle = fuelSchedule6.calculateEndAngle(currentStatus.injAngle);
              injector7EndAngle = fuelSchedule7.calculateEndAngle(currentStatus.injAngle);
              injector8EndAngle = fuelSchedule8.calculateEndAngle(currentStatus.injAngle);
...
void calculateIgnitionAngles()
{
  ...
  switch (configPage2.nCylinders)
  {
    //1 cylinder
    case 1:
      ignitionSchedule1.setAdvance(currentStatus.advance);
      break;
    //2 cylinders
    case 2:
      ignitionSchedule1.setAdvance(currentStatus.advance);
      ignitionSchedule2.setAdvance(currentStatus.advance);
      break;
    //3 cylinders
    case 3:
      ignitionSchedule1.setAdvance(currentStatus.advance);
      ignitionSchedule2.setAdvance(currentStatus.advance);
      ignitionSchedule3.setAdvance(currentStatus.advance);
      break;
    //4 cylinders
    case 4:
      ignitionSchedule1.setAdvance(currentStatus.advance);
      ...
      if((configPage4.sparkMode == IGN_MODE_SEQUENTIAL) && currentStatus.hasSync)
      {
        ...
        ignitionSchedule3.setAdvance(currentStatus.advance);
        ignitionSchedule4.setAdvance(currentStatus.advance);
      }
    ...
    case 5:
      ...
      ignitionSchedule3.setAdvance(currentStatus.advance);
      ignitionSchedule4.setAdvance(currentStatus.advance);
      ignitionSchedule5.setAdvance(currentStatus.advance);
      break;
    //6 cylinders
    case 6:
      ignitionSchedule1.setAdvance(currentStatus.advance);
      ...
      ignitionSchedule4.setAdvance(currentStatus.advance);
      ignitionSchedule5.setAdvance(currentStatus.advance);
      ignitionSchedule6.setAdvance(currentStatus.advance);
      }
      else
      {
        if( BIT_CHECK(currentStatus.status3, BIT_STATUS3_HALFSYNC) && (CRANK_ANGLE_MAX_IGN != 360) ) { changeFullToHalfSync(); }
    ...
    case 8:
      ...
      ignitionSchedule5.setAdvance(currentStatus.advance);
      ignitionSchedule6.setAdvance(currentStatus.advance);
      ignitionSchedule7.setAdvance(currentStatus.advance);
      ignitionSchedule8.setAdvance(currentStatus.advance);
      }
      else
      {
        if( BIT_CHECK(currentStatus.status3, BIT_STATUS3_HALFSYNC) && (CRANK_ANGLE_MAX_IGN != 360) ) { changeFullToHalfSync(); }
