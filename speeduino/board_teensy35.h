...
*/
  ...
  inline void FUEL1_TIMER_ENABLE() { FTM0_C0SC |= FTM_CSC_CHIE; } //Write 1 to the CHIE (Channel Interrupt Enable) bit of channel 0 Status/Control
  inline void FUEL2_TIMER_ENABLE() { FTM0_C1SC |= FTM_CSC_CHIE; }
  inline void FUEL3_TIMER_ENABLE() { FTM0_C2SC |= FTM_CSC_CHIE; }
  inline void FUEL4_TIMER_ENABLE() { FTM0_C3SC |= FTM_CSC_CHIE; }
  inline void FUEL5_TIMER_ENABLE() { FTM3_C0SC |= FTM_CSC_CHIE; }
  inline void FUEL6_TIMER_ENABLE() { FTM3_C1SC |= FTM_CSC_CHIE; }
  inline void FUEL7_TIMER_ENABLE() { FTM3_C2SC |= FTM_CSC_CHIE; }
  inline void FUEL8_TIMER_ENABLE() { FTM3_C3SC |= FTM_CSC_CHIE; }

  inline void FUEL1_TIMER_DISABLE() { FTM0_C0SC &= ~FTM_CSC_CHIE; } //Write 0 to the CHIE (Channel Interrupt Enable) bit of channel 0 Status/Control
  inline void FUEL2_TIMER_DISABLE() { FTM0_C1SC &= ~FTM_CSC_CHIE; }
  inline void FUEL3_TIMER_DISABLE() { FTM0_C2SC &= ~FTM_CSC_CHIE; }
  inline void FUEL4_TIMER_DISABLE() { FTM0_C3SC &= ~FTM_CSC_CHIE; }
  inline void FUEL5_TIMER_DISABLE() { FTM3_C0SC &= ~FTM_CSC_CHIE; } //Write 0 to the CHIE (Channel Interrupt Enable) bit of channel 0 Status/Control
  inline void FUEL6_TIMER_DISABLE() { FTM3_C1SC &= ~FTM_CSC_CHIE; }
  inline void FUEL7_TIMER_DISABLE() { FTM3_C2SC &= ~FTM_CSC_CHIE; }
  inline void FUEL8_TIMER_DISABLE() { FTM3_C3SC &= ~FTM_CSC_CHIE; }

  inline void IGN1_TIMER_ENABLE() { FTM0_C4SC |= FTM_CSC_CHIE; }
  inline void IGN2_TIMER_ENABLE() { FTM0_C5SC |= FTM_CSC_CHIE; }
  inline void IGN3_TIMER_ENABLE() { FTM0_C6SC |= FTM_CSC_CHIE; }
  inline void IGN4_TIMER_ENABLE() { FTM0_C7SC |= FTM_CSC_CHIE; }
  inline void IGN5_TIMER_ENABLE() { FTM3_C4SC |= FTM_CSC_CHIE; }
  inline void IGN6_TIMER_ENABLE() { FTM3_C5SC |= FTM_CSC_CHIE; }
  inline void IGN7_TIMER_ENABLE() { FTM3_C6SC |= FTM_CSC_CHIE; }
  inline void IGN8_TIMER_ENABLE() { FTM3_C7SC |= FTM_CSC_CHIE; }

  inline void IGN1_TIMER_DISABLE() { FTM0_C4SC &= ~FTM_CSC_CHIE; }
  inline void IGN2_TIMER_DISABLE() { FTM0_C5SC &= ~FTM_CSC_CHIE; }
  inline void IGN3_TIMER_DISABLE() { FTM0_C6SC &= ~FTM_CSC_CHIE; }
  inline void IGN4_TIMER_DISABLE() { FTM0_C7SC &= ~FTM_CSC_CHIE; }
  inline void IGN5_TIMER_DISABLE() { FTM3_C4SC &= ~FTM_CSC_CHIE; }
  inline void IGN6_TIMER_DISABLE() { FTM3_C5SC &= ~FTM_CSC_CHIE; }
  inline void IGN7_TIMER_DISABLE() { FTM3_C6SC &= ~FTM_CSC_CHIE; }
  inline void IGN8_TIMER_DISABLE() { FTM3_C7SC &= ~FTM_CSC_CHIE; }
