...
*/
  ...
  */
  ...
  inline void FUEL1_TIMER_ENABLE() { TMR1_CSCTRL0 |= TMR_CSCTRL_TCF1EN; } //Write 1 to the TCFIEN (Channel Interrupt Enable) bit of channel 0 Status/Control
  inline void FUEL2_TIMER_ENABLE() { TMR1_CSCTRL1 |= TMR_CSCTRL_TCF1EN; }
  inline void FUEL3_TIMER_ENABLE() { TMR1_CSCTRL2 |= TMR_CSCTRL_TCF1EN; }
  inline void FUEL4_TIMER_ENABLE() { TMR1_CSCTRL3 |= TMR_CSCTRL_TCF1EN; }
  inline void FUEL5_TIMER_ENABLE() { TMR3_CSCTRL0 |= TMR_CSCTRL_TCF1EN; }
  inline void FUEL6_TIMER_ENABLE() { TMR3_CSCTRL1 |= TMR_CSCTRL_TCF1EN; }
  inline void FUEL7_TIMER_ENABLE() { TMR3_CSCTRL2 |= TMR_CSCTRL_TCF1EN; }
  inline void FUEL8_TIMER_ENABLE() { TMR3_CSCTRL3 |= TMR_CSCTRL_TCF1EN; }

  inline void FUEL1_TIMER_DISABLE() { TMR1_CSCTRL0 &= ~TMR_CSCTRL_TCF1EN; } //Write 0 to the TCFIEN (Channel Interrupt Enable) bit of channel 0 Status/Control
  inline void FUEL2_TIMER_DISABLE() { TMR1_CSCTRL1 &= ~TMR_CSCTRL_TCF1EN; }
  inline void FUEL3_TIMER_DISABLE() { TMR1_CSCTRL2 &= ~TMR_CSCTRL_TCF1EN; }
  inline void FUEL4_TIMER_DISABLE() { TMR1_CSCTRL3 &= ~TMR_CSCTRL_TCF1EN; }
  inline void FUEL5_TIMER_DISABLE() { TMR1_CSCTRL0 &= ~TMR_CSCTRL_TCF1EN; }
  inline void FUEL6_TIMER_DISABLE() { TMR1_CSCTRL1 &= ~TMR_CSCTRL_TCF1EN; }
  inline void FUEL7_TIMER_DISABLE() { TMR1_CSCTRL2 &= ~TMR_CSCTRL_TCF1EN; }
  inline void FUEL8_TIMER_DISABLE() { TMR1_CSCTRL3 &= ~TMR_CSCTRL_TCF1EN; }

  inline void IGN1_TIMER_ENABLE() { TMR2_CSCTRL0 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN2_TIMER_ENABLE() { TMR2_CSCTRL1 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN3_TIMER_ENABLE() { TMR2_CSCTRL2 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN4_TIMER_ENABLE() { TMR2_CSCTRL3 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN5_TIMER_ENABLE() { TMR4_CSCTRL0 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN6_TIMER_ENABLE() { TMR4_CSCTRL1 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN7_TIMER_ENABLE() { TMR4_CSCTRL2 |= TMR_CSCTRL_TCF1EN; }
  inline void IGN8_TIMER_ENABLE() { TMR4_CSCTRL3 |= TMR_CSCTRL_TCF1EN; }

  inline void IGN1_TIMER_DISABLE() { TMR2_CSCTRL0 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN2_TIMER_DISABLE() { TMR2_CSCTRL1 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN3_TIMER_DISABLE() { TMR2_CSCTRL2 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN4_TIMER_DISABLE() { TMR2_CSCTRL3 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN5_TIMER_DISABLE() { TMR4_CSCTRL0 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN6_TIMER_DISABLE() { TMR4_CSCTRL1 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN7_TIMER_DISABLE() { TMR4_CSCTRL2 &= ~TMR_CSCTRL_TCF1EN; }
  inline void IGN8_TIMER_DISABLE() { TMR4_CSCTRL3 &= ~TMR_CSCTRL_TCF1EN; }
