...
*/
  ...
  inline void FUEL1_TIMER_ENABLE() { TIFR3 |= (1<<OCF3A); TIMSK3 |= (1 << OCIE3A); } //Turn on the A compare unit (ie turn on the interrupt)
  inline void FUEL2_TIMER_ENABLE() { TIFR3 |= (1<<OCF3B); TIMSK3 |= (1 << OCIE3B); } //Turn on the B compare unit (ie turn on the interrupt)
  inline void FUEL3_TIMER_ENABLE() { TIFR3 |= (1<<OCF3C); TIMSK3 |= (1 << OCIE3C); } //Turn on the C compare unit (ie turn on the interrupt)
  inline void FUEL4_TIMER_ENABLE() { TIFR4 |= (1<<OCF4B); TIMSK4 |= (1 << OCIE4B); } //Turn on the B compare unit (ie turn on the interrupt)
  inline void FUEL5_TIMER_ENABLE() { TIFR4 |= (1<<OCF4C); TIMSK4 |= (1 << OCIE4C); } //Turn on the C compare unit (ie turn on the interrupt)
  inline void FUEL6_TIMER_ENABLE() { TIFR4 |= (1<<OCF4A); TIMSK4 |= (1 << OCIE4A); } //Turn on the A compare unit (ie turn on the interrupt)
  inline void FUEL7_TIMER_ENABLE() { TIFR5 |= (1<<OCF5C); TIMSK5 |= (1 << OCIE5C); } //
  inline void FUEL8_TIMER_ENABLE() { TIFR5 |= (1<<OCF5B); TIMSK5 |= (1 << OCIE5B); } //

  inline void FUEL1_TIMER_DISABLE() { TIMSK3 &= ~(1 << OCIE3A); } //Turn off this output compare unit
  inline void FUEL2_TIMER_DISABLE() { TIMSK3 &= ~(1 << OCIE3B); } //Turn off this output compare unit
  inline void FUEL3_TIMER_DISABLE() { TIMSK3 &= ~(1 << OCIE3C); } //Turn off this output compare unit
  inline void FUEL4_TIMER_DISABLE() { TIMSK4 &= ~(1 << OCIE4B); } //Turn off this output compare unit
  inline void FUEL5_TIMER_DISABLE() { TIMSK4 &= ~(1 << OCIE4C); } //
  inline void FUEL6_TIMER_DISABLE() { TIMSK4 &= ~(1 << OCIE4A); } //
  inline void FUEL7_TIMER_DISABLE() { TIMSK5 &= ~(1 << OCIE5C); } //
  inline void FUEL8_TIMER_DISABLE() { TIMSK5 &= ~(1 << OCIE5B); } //
  ...
  inline void IGN1_TIMER_ENABLE() { TIFR5 |= (1<<OCF5A); TIMSK5 |= (1 << OCIE5A); } //Turn on the A compare unit (ie turn on the interrupt)
  inline void IGN2_TIMER_ENABLE() { TIFR5 |= (1<<OCF5B); TIMSK5 |= (1 << OCIE5B); } //Turn on the B compare unit (ie turn on the interrupt)
  inline void IGN3_TIMER_ENABLE() { TIFR5 |= (1<<OCF5C); TIMSK5 |= (1 << OCIE5C); } //Turn on the C compare unit (ie turn on the interrupt)
  inline void IGN4_TIMER_ENABLE() { TIFR4 |= (1<<OCF4A); TIMSK4 |= (1 << OCIE4A); } //Turn on the A compare unit (ie turn on the interrupt)
  inline void IGN5_TIMER_ENABLE() { TIFR4 |= (1<<OCF4C); TIMSK4 |= (1 << OCIE4C); } //Turn on the A compare unit (ie turn on the interrupt)
  inline void IGN6_TIMER_ENABLE() { TIFR4 |= (1<<OCF4B); TIMSK4 |= (1 << OCIE4B); } //Replaces injector 4
  inline void IGN7_TIMER_ENABLE() { TIMSK3 |= (1 << OCIE3C); } //Replaces injector 3
  inline void IGN8_TIMER_ENABLE() { TIMSK3 |= (1 << OCIE3B); } //Replaces injector 2

  inline void IGN1_TIMER_DISABLE() { TIMSK5 &= ~(1 << OCIE5A); } //Turn off this output compare unit
  inline void IGN2_TIMER_DISABLE() { TIMSK5 &= ~(1 << OCIE5B); } //Turn off this output compare unit
  inline void IGN3_TIMER_DISABLE() { TIMSK5 &= ~(1 << OCIE5C); } //Turn off this output compare unit
  inline void IGN4_TIMER_DISABLE() { TIMSK4 &= ~(1 << OCIE4A); } //Turn off this output compare unit
  inline void IGN5_TIMER_DISABLE() { TIMSK4 &= ~(1 << OCIE4C); } //Turn off this output compare unit
  inline void IGN6_TIMER_DISABLE() { TIMSK4 &= ~(1 << OCIE4B); } //Replaces injector 4
  inline void IGN7_TIMER_DISABLE() { TIMSK3 &= ~(1 << OCIE3C); } //Replaces injector 3
  inline void IGN8_TIMER_DISABLE() { TIMSK3 &= ~(1 << OCIE3B); } //Replaces injector 2
